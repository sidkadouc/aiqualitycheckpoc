...
@description('Whether the service is reachable from the public internet. Set to disabled when fronting with a private endpoint.')
...
// Search service names are globally unique; append a short RG-scoped hash.
var nameSuffix = take(uniqueString(resourceGroup().id), 6)

// Azure AI Search Service
resource searchService 'Microsoft.Search/searchServices@2024-06-01-preview' = {
  name: 'srch-${environmentName}-${nameSuffix}'
  location: location
  tags: tags
  sku: {
    name: 'basic'
